  ...
  return (
    <section className="flex flex-col items-center text-center py-24 px-4 bg-[#FAF5F5]">
      ...
      <p className="text-xl text-[#4A4A4A] max-w-2xl mb-10">
        Rbeka is your AI-powered MBA study companion built by an alumnus who
        knows the grind. Ask questions about your coursework and get instant,
        well-sourced answers drawn directly from your class materials.
      </p>
