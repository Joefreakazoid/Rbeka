  ...
  return (
    <section className="flex flex-col items-center text-center py-24 px-4">
      ...
      <h1 className="text-5xl md:text-6xl font-bold text-gray-900 leading-tight max-w-3xl mb-6">
        Your Personal{" "}
        <span className="text-blue-600">MBA Study Companion</span>
      </h1>
      ...
      <div className="flex flex-col sm:flex-row items-center gap-4">
        <Link
          href="/chat"
          className="inline-flex items-center gap-2 rounded-xl bg-blue-600 px-6 py-3.5 text-base font-semibold text-white shadow hover:bg-blue-700 transition-colors"
        >
          Get Started Free
          <svg
            xmlns="http://www.w3.org/2000/svg"
        ...
        <a
          ...
          className="inline-flex items-center gap-2 rounded-xl border border-gray-300 bg-white px-6 py-3.5 text-base font-semibold text-gray-700 shadow-sm hover:bg-gray-50 transition-colors"
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 24 24"
